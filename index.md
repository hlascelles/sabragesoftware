...
From just one press on the homescreen, you can begin typing immediately. Defaults values can be set
for the
tasks, and they will be uploaded at once, or when an internet connection becomes available. Note,
this app is not standalone - it is for use with the (free) [ToodleDo][toodledo] Task List web
application.
